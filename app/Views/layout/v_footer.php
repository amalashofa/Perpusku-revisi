        ...
        <div class="container-fluid text-center text-md-left mt-4">
            <div class="row">
                ...
                <div class="col-md-6 mt-md-0 mt-3">
                    <!-- Content -->
                    <h5><img src="<?= base_url('assets/img/logo/logo50px.webp') ?>" height="50px" width="50px"> Perpusku</h5>
                    <p>Meminjam buku sekarang jadi lebih mudah menggunakan Perpusku</p>
                </div>
