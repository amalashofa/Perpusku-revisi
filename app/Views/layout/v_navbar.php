...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="<?= base_url('/') ?>">
            ...
            <span class="navbar-brand ml-1">Perpusku</span>
        </a>
            ...
            <?php if (session()->get('isLoggedIn')) { ?>
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item <?= ($uri->getSegment(1)) == 'library' ? 'active' : null ?>">
                        <a class="nav-link" href="<?= base_url('library') ?>">Perpustakaan</a>
                    </li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                            ...
                            <?php if ($user['jabatan'] != 1) { ?>
                                ...
                                <a class="dropdown-item" href="<?= base_url('myBook') ?>"><i class="fas fa-book"></i> Buku </a>
                            <?php } ?>
                            <div class="dropdown-divider"></div>
